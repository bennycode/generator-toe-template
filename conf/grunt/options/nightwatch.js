module.exports = {
  options: {
    ...
    globals_path: '<%= dir.src_test_e2e_conf %>/globals.js',
    src_folders: [
      '<%= dir.build_test_e2e_js %>'
    ],
    output_folder: '<%= dir.docs_e2e %>',
    "test_settings": {
      "default": {
  ...
  "browserstack": {
    ...
    src_folders: [
      '<%= dir.src_test_js_nightwatch_tests %>'
    ],
