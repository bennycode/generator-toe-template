module.exports = function(grunt) {
  ...
  grunt.registerTask('build_test_e2e_coffee', function() {
    grunt.task.run([
      'clean:' + grunt.config('build_test_e2e_coffee'),
      'coffee:build_test_e2e_coffee'
    ]);
  });
  ...
  grunt.registerTask('build_test_e2e_js', function() {
    grunt.task.run([
      'clean:build_test_e2e_js',
      'copy:build_test_e2e_js'
    ]);
  });
